...
/*******************************************************************************
 * Testovací třída {@code CommandFightTest} slouží ke komplexnímu otestování
 * třídy {@link CommandFightTest}.
 *
 * @author Patrik Pukan
...
public class CommandFightTest
{
    ...
    {
        assertEquals("Tomu nerozumím, musíš mi říct, s kym mam bojovat.", game.process("boj"));
        assertEquals("Tomu nerozumím, neumím robit viac bojov naraz.", game.process("boj a b"));
    }
}
